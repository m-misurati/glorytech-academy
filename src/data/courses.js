...
// Titles match the recorded file names exactly; durations are read from the uploaded videos.
const ccna1Lessons = [
  ['CCNA1 Introduction to Networks', 611, true],
  ['Module-1 Networking Today', 4915],
  ['Module-2 Basic Switch and End Device Configuration', 2485],
  ['Module-3 Protocols and Models', 7755],
  ['Module-4 Physical Layer', 7202],
  ['Module-5 Numbering Systems', 992],
  ['Module-6 Data Link Layer', 1718],
  ['Module-7 Ethernet Switching', 3782],
  ['Module-8 Network Layer', 5392],
  ['Module-9 Address Resolution', 1781],
  ['Module-10 Basic Router Configuration', 1830],
  ['Module-11 IPv4 Addressing', 6016],
  ['Module-12 IPv6 Addressing', 4711],
  ['Module-13 ICMP', 2152],
  ['Module-14 Transport Layer', 4870],
  ['Module-15 Application Layer', 4682],
  ['Module-16 Network Security Fundamentals', 4508],
  ['Module-17 Build a Small Network', 3574],
